...
const NEW_ARRAY = require("./references/Newarray.class").NEW_ARRAY;
const SASTORE = require("./stores/Xastore.class").SASTORE;
const CASTORE = require("./stores/Xastore.class").CASTORE;
const BASTORE = require("./stores/Xastore.class").BASTORE;
const AASTORE = require("./stores/Xastore.class").AASTORE;
const DASTORE = require("./stores/Xastore.class").DASTORE;
const FASTORE = require("./stores/Xastore.class").FASTORE;
const LASTORE = require("./stores/Xastore.class").LASTORE;
const IASTORE = require("./stores/Xastore.class").IASTORE;
const SALOAD = require("./loads/Xaload.class").SALOAD;
const CALOAD = require("./loads/Xaload.class").CALOAD;
const BALOAD = require("./loads/Xaload.class").BALOAD;
const AALOAD = require("./loads/Xaload.class").AALOAD;
const DALOAD = require("./loads/Xaload.class").DALOAD;
const FALOAD = require("./loads/Xaload.class").FALOAD;
const LALOAD = require("./loads/Xaload.class").LALOAD;
const IALOAD = require("./loads/Xaload.class").IALOAD;
const INVOKE_INTERFACE = require("./references/Invokeinterface.class").INVOKE_INTERFACE;
const INVOKE_STATIC = require("./references/Invokestatic.class").INVOKE_STATIC;
const ARETURN = require("./control/Return.class").ARETURN;
const RETURN = require("./control/Return.class").RETURN;
const DRETURN = require("./control/Return.class").DRETURN;
const FRETURN = require("./control/Return.class").FRETURN;
const LRETURN = require("./control/Return.class").LRETURN;
const IRETURN = require("./control/Return.class").IRETURN;
const INVOKE_SPECIAL = require("./references/Invokespecial.class").INVOKE_SPECIAL;
const INVOKE_VIRTURL = require("./references/Invokevirtual.class").INVOKE_VIRTURL;
const PUT_FIELD = require("./references/Putfield.class").PUT_FIELD;
const GET_FIELD = require("./references/Getfield.class").GET_FIELD;
const PUT_STATIC = require("./references/Putstatic.class").PUT_STATIC;
const GET_STATIC = require("./references/Getstatic.class").GET_STATIC;
const INSTANCE_OF = require("./references/Instanceof.class").INSTANCE_OF;
const CHECK_CAST = require("./references/Checkcast.class").CHECK_CAST;
const NEW = require("./references/New.class").NEW;
const LDC2_W = require("./constants/Ldc.class").LDC2_W;
const LDC_W = require("./constants/Ldc.class").LDC_W;
const LDC = require("./constants/Ldc.class").LDC;
