...
// 执行ParseIntTest程序
// 1. 输入参数 123
// let fake_args = ['node', 'main.js', '--Xjre', Xjre_path, '--classpath', resources_path, 'jvmgo.book.ch10.ParseIntTest', '123'];

// 2. 输入参数 abc
// let fake_args = ['node', 'main.js', '--Xjre', Xjre_path, '--classpath', resources_path, 'jvmgo.book.ch10.ParseIntTest', 'abc'];

// 3. 无输入参数
let fake_args = ['node', 'main.js', '--Xjre', Xjre_path, '--classpath', resources_path, 'jvmgo.book.ch10.ParseIntTest'];
