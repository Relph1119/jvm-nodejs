...
![](images/ch02/read-class-file.png)

1. 由于Node.js的异步机制，在遍历文件夹目录的时候，采用递归的做法，没有用`walk`模块。
2. Node.js和Java很像，不能按照Python的方式返回多个参数，笔者采用了返回Map对象，代替多个返回值的实现。
...
![](images/ch03/parse-class-file.png)
...
![](images/ch05/test-GaussTest.png)
...
![](images/ch07/test-Fibonacci.png)
...
![](images/ch08/test-BubbleSortTest.png)

2. 解析并执行HelloWorld程序，打印出Hello world!

![](images/ch08/test-HelloWorld.png)

3. 解析并执行PrintArgs程序，打印出传入的参数

![](images/ch08/test-PrintArgs.png)
